...
public class DataHandlerTest{
  ...
  public void test03() throws Throwable { 
	...
	dh2.saveAppt(appt);
	assertTrue(dh2.saveAppt(appt));
	//assertFalse(dh2.isAutoSave());
  ...
  public void test0b() throws Throwable { 
	...
	//assertFalse(dh1.saveAppt(appt));
//	assertFalse(dh1.deleteAppt(appt));
//	assertNull(dh1.getApptRange(firstDay,lastDay));	
 ...
 //this year,month,day 
  ...
  public void test2b() throws Throwable { 
  	DataHandler dh1 = new DataHandler("dhfile3");
	GregorianCalendar firstDay = new GregorianCalendar(2018,9,11);
	GregorianCalendar lastDay = new GregorianCalendar(2018,9,13);
	Appt appt = new Appt(10,30,9,9,2018,"bday","this is my bday","email@gmail.com"); 
	Appt appt2 = new Appt(9,30,9,9,2019,"bday","this is my bday","email@gmail.com"); 
	//assertEquals("Second date specified is not before the first date specified.",dh1.getApptRange(firstDay,lastDay));
  //	dh1.saveAppt(appt);
//	assertTrue(dh1.deleteAppt(appt));
//	assertTrue(dh1.save());
	dh1.getApptRange(firstDay,lastDay);
  }
